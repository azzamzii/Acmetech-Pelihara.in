package com.acmetech.peliharain.ui.theme
...
fun PeliharainTheme(
    ...
    ProvidePeliharainColors(colors) {
        MaterialTheme(
...
object PeliharainTheme {
    val colors: Colors
        @Composable
        get() = LocalPeliharainColors.current
}
...
fun ProvidePeliharainColors(
    ...
    CompositionLocalProvider(LocalPeliharainColors provides colorPalette, content = content)
}

private val LocalPeliharainColors = staticCompositionLocalOf<Colors> {
