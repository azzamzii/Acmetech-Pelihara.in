...
fun RegisterPage(
    ...
    Column(
        ...
        Box(contentAlignment = Alignment.Center, modifier = Modifier.height(160.dp)) {
            ...
            Image(
                painter = painterResource(id = R.drawable.logoregis),
        ...
        Column(horizontalAlignment = Alignment.Start) {
            ...
            Text(
                text = "Daftarkan Dirimu Untuk Menikmati Layanan Kami",
                style = TextStyle(
                    fontWeight = FontWeight.Bold,
                    fontSize = 14.sp,
                    color = Color.Gray
            ...
            Button(
                onClick = {
                    if (email.isNotEmpty() && password.isNotEmpty()) {
                        ...
                        Toast.makeText(context, "Field tidak boleh kosong", Toast.LENGTH_SHORT)
                            .show()
                    }
                },
